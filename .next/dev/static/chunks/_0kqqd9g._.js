...
function AdminLayout({ children }) {
    ...
    const handleLogout = async ()=>{
        try {
            const { createClient } = await __turbopack_context__.A("[project]/utils/supabase/client.ts [app-client] (ecmascript, async loader)");
            const supabase = createClient();
            await supabase.auth.signOut();
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("Has cerrado sesión exitosamente", {
                description: "Esperamos verte pronto."
            });
            router.push('/admin/login');
            router.refresh(); // Force a full re-evaluation of the middleware
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Hubo un error al cerrar sesión.");
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AdminLayout, "d0b+IZ7Ggsa4uwV5qnFBKY2OGzI=", false, function() {
    return [
...
//# sourceMappingURL=_0kqqd9g._.js.map