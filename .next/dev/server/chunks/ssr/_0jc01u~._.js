...
function createClient() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createBrowserClient"])(("TURBOPACK compile-time value", "https://unfrhtadfueyezpphute.supabase.co"), ("TURBOPACK compile-time value", "sb_publishable_qqgsoYo19ONIzTwlh1jqeQ_xKrj2Seh"));
}
}),
...
function AdminLogin() {
    ...
    const handleLogin = async (e)=>{
        ...
        if (error && error.message.includes("Invalid login")) {
            ...
            if (signUpError) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`Error: ${signUpError.message}`);
                setIsLoggingIn(false);
                return;
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Cuenta creada. Redirigiendo...");
                setIsLoggingIn(false);
                router.push('/');
                router.refresh();
                return;
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Credenciales incorrectas.");
            setIsLoggingIn(false);
            return;
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Bienvenido al panel de administración");
        setIsLoggingIn(false);
        router.push('/admin');
        router.refresh();
    };
...
//# sourceMappingURL=_0jc01u~._.js.map